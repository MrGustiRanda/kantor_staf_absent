    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ route('absent.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <select class="form-control" name="id_staff" id="id_staff">
                                        @foreach ($staff as $s)
                                            <option value="{{ $s->id }}" {{ ($s->id == $data->staff_id) ? 'selected' : '' }}>{{ $s->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="time" class="form-control" name="time_start" value="{{ old('time_start', $data->time_start) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="time" class="form-control" name="time_end" value="{{ old('time_end', $data->time_end) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="overtime" value="{{ old('overtime', $data->overtime) }}">
                                </div>
                            </div>
                        </div>
                        <div>
